<!-- Andrew Sparkes -->
<!-- STAT331 Assignment 4 - Due 10/31/25 -->
<!-- In Class "Challenge" -->
...
p3 <- spending_and_pop_with_shapes |>
  ...
  guides(fill = guide_legend(title = "Log Scale of Award/Population", theme(legend.title.position = "top"))) +
  #guides(alpha = "none") + 
  geom_sf(#data = centroid,
          aes(fill = log(`Award Amount` / `Pop`), label = "Log scale Amt/Pop")
          #pch = 21,
          #aes(size = Pop),
          #fill = alpha("red", 0.4)
          ) +
