...
# probably not the exact right thing, but https://mpn.metworx.com/packages/shinydashboard/0.7.1/reference/renderValueBox.html may shed some light. Perhaps render the boxes and pass the raw html to barf out in the rmd? Can the rmd take raw html? Shiny can, but can Rmd? I hope so...
```
